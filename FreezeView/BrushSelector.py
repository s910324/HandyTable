...
class BrushSelector(QWidget):
    def __init__(self, parent=None):
        ...
        self.hex_list = [
            ...
            [-110 + x, 162 + y, '#FF4E4E'], [-110 + x, 180 + y, '#FF0A0A'], [-110 + x, 198 + y, '#C50000'], [-110 + x, 216 + y, '#820011'], [ -95 + x,   9 + y, '#006F81'], [ -95 + x,  27 + y, '#00A4C5'], 
            [ -95 + x,  45 + y, '#0ACBFF'], [ -95 + x,  63 + y, '#4ECBFF'], [ -95 + x,  81 + y, '#93CCFF'], [ -95 + x,  99 + y, '#D7D8FF'], [ -95 + x, 117 + y, '#FFD7FD'], [ -95 + x, 135 + y, '#FF93C5'], 
            [ -95 + x, 153 + y, '#FF4E82'], [ -95 + x, 171 + y, '#FF0A3E'], [ -95 + x, 189 + y, '#C50020'], [ -95 + x, 207 + y, '#810011'], [ -80 + x,  18 + y, '#005B81'], [ -80 + x,  36 + y, '#007EC5'], 
            [ -80 + x,  54 + y, '#0A8DFF'], [ -80 + x,  72 + y, '#4E8EFF'], [ -80 + x,  90 + y, '#9397FF'], [ -80 + x, 108 + y, '#C993FF'], [ -80 + x, 126 + y, '#FF93FA'], [ -80 + x, 144 + y, '#FF4EBF'], 
            [ -80 + x, 162 + y, '#FF0A7C'], [ -80 + x, 180 + y, '#C50047'], [ -80 + x, 198 + y, '#810025'], [ -65 + x,  27 + y, '#004581'], [ -65 + x,  45 + y, '#0055C5'], [ -65 + x,  63 + y, '#0A4DFF'], 
            [ -65 + x,  81 + y, '#4E55FF'], [ -65 + x,  99 + y, '#844EFF'], [ -65 + x, 117 + y, '#C94EFF'], [ -65 + x, 135 + y, '#FF4EF8'], [ -65 + x, 153 + y, '#FF0ABB'], [ -65 + x, 171 + y, '#C50070'], 
            [ -65 + x, 189 + y, '#81003C'], [ -50 + x,  36 + y, '#002E81'], [ -50 + x,  54 + y, '#002CC5'], [ -50 + x,  72 + y, '#0A14FF'], [ -50 + x,  90 + y, '#3D0AFF'], [ -50 + x, 108 + y, '#840AFF'], 
            [ -50 + x, 126 + y, '#CC0AFF'], [ -50 + x, 144 + y, '#FF0AF5'], [ -50 + x, 162 + y, '#C50099'], [ -50 + x, 180 + y, '#810052'], [ -35 + x,  45 + y, '#001881'], [ -35 + x,  63 + y, '#0007C5'], 
